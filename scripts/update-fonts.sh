#!/usr/bin/env bash
# Re-downloads the self-hosted font file from Google Fonts.
# Run this whenever you want to pick up a new font version.
# Only the latin subset is needed — the German UI text (incl. ä/ö/ü/ß and the
# „" · – punctuation) all falls within the latin subset's unicode-range.
